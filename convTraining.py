...
class ConvNN(nn.Module):
    def __init__(self):
        ...
        # Полносвязные слои
        self.fc1 = nn.Linear(64 * 8 * 8, 700)
        self.fc2 = nn.Linear(700, 26)
...
def main():
    ...
    train_transform = transforms.Compose(
        [
            ...
            transforms.RandomRotation(10),  # Случайное вращение
    ...
    # Тренировка модели
    model = train(model, loss_fn, optimizer, train_loader, n_epochs=500)
